    ...
    <x-slot name="welcome">
        ...
        <div class="space-y-5 md:space-y-8">
            <div class="space-y-3">
                ...
                <h2 class="text-2xl font-bold dark:text-white md:text-3xl">ユーザーマニュアル
                </h2>
            ...
            <a href="{{ route('login') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:text-red-600 dark:hover:text-white">ここからログイン</a><br>
